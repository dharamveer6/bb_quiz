...
const { createTriviaQuizz, getQuizz, viewDetails, chnageBanner } = require('../controllers/triviaQuizzController');
...
triviaRoute.route('/change/banner').get(uploadimage.single('banner'),chnageBanner);
